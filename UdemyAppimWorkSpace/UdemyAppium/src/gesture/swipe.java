...
public class swipe {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException 
	{
		...
		t.press(driver.findElement(By.xpath("//*[@content-desc='15']"))).waitAction(Duration.ofMillis(3000)).moveTo(driver.findElement(By.xpath("//*[@content-desc='45']"))).release().perform();

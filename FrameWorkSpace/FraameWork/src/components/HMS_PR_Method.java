...
import objectRepository.HMS_PR_Locator;
import utility.BaseClass;
import utility.ReadData;

public class HMS_PR_Method  extends BaseClass
{
	HMS_PR_Locator locator=new HMS_PR_Locator();
	public HMS_PR_Method(ReadData readData)
	{

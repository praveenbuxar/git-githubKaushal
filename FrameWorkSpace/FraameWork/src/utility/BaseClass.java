...
public class BaseClass {
	...
	public  static void verifyLinks(By locator)
	{
		WebElement page_links=driver.findElement(locator);
		List<WebElement>links=page_links.findElements(By.tagName("a"));
	...
	public void clickRadioButton(By locator)  {
		try {
			...
			System.out.println("Error in clicking RadioButton:" + locator + "Fail");
			// readData.addStepDetails("Select Radio button", "Radio button shoud be available", "Error in clicking RadioButton: " + localRuntimeException.getMessage(), "FAIL","N");
			localRuntimeException.getMessage();
		}
	}
	...
	public void clickImage(By locator){
		...
		{
			System.out.println("Error in clickng Image:"+locator+"Fail");
			//     readData.addStepDetails("Click Image", "Image should be available", "Error in clikcing on Image: " + localRuntimeException.getMessage(), "FAIL","N");
			localRuntimeException.getMessage();
		}
	}
	...
	public void afterSuite() throws Exception{
		try{
			...
			//Sendmail.ComposeGmail("testingse2@gmail.com", "nag010683@gmail.com",local);
